...
import { Lock, Mail, User as UserIcon, AlertCircle, Loader } from 'lucide-react';
    ...
    <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
      <div className="w-full max-w-md bg-white p-8 rounded-[2rem] border border-slate-200/50 shadow-[0_8px_30px_rgb(0,0,0,0.03)] relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-xs mt-2">Get your $100k paper-trading balance instantly</p>
        </div>
